...
export default function CreateForm({ formId, errors, register, setValue }: { formId: string, errors: FieldErrors<Project>, register: UseFormRegister<Project>, setValue: UseFormSetValue<Project> }) {
    return <div>
        <form id={formId} className="flex flex-col gap-4 max-h-96 overflow-y-auto p-2">
